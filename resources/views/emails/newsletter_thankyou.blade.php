	...
	max-width: 500px;" class="wrapper">
			...
			padding-bottom: 20px;">
				...
				color: #2D3445;" class="preheader">
                                Cảm ơn anh/chị đã đăng ký nhận bảng tin tại Khanh Blog.</div>
			...
			padding-bottom: 0;
			color: #FFFFFF;
			font-family: 'Manrope', sans-serif;" class="supheader">
                            THÀNH VIÊN
                        </td>
                    </tr>
			...
			padding-top: 5px;
			color: #FFFFFF;
			font-family: 'Manrope', sans-serif;" class="header">
                            Đăng ký nhận bảng tin tại Khanh Blog
                        </td>
                    </tr>
			...
			padding-top: 15px; 
			color: #FFFFFF;
			font-family: 'Manrope', sans-serif;" class="paragraph">
                            Anh/chị sẽ nhận được thông báo email khi có bài đăng mới xuất hiện tại Khanh Blog cùng những
                            thông tin bổ ích trong tương lai.
                        </td>
                    </tr>
