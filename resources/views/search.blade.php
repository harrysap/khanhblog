...
<x-layouts.appclient>
    ...
    @endphp
    <div class="">
        <section class="max-w-default mx-auto px-4 sm:px-6 default:px-0 flex flex-col justify-between gap-14 pt-8">
            <div class="relative p-6 text-center w-full flex flex-col gap-6" x-data="{ searchText: '{{ $searchQuery }}' }">
                <h1 class="text-3xl font-bold">Kết quả tìm kiếm cho "{{ $searchQuery }}"</h1>
                <div>
                    <div
                            ...
                            <div class="justify-between gap-6 h-full hidden md:flex">
                                <div class="relative overflow-hidden">
                                    <div
                                        ...
                                        <a href="/blog/category/{{ $post['categories'][0] }}">
                                    ...
                                    <a href="/blog/{{ $post['slug'] }}">
                                        <img class="aspect-1 h-[250px] rounded-xl opacity-95 hover:opacity-85 transition-opacity duration-150 ease-linear object-cover"
                                            src="/{{ $post['thumbnail_url'] }}" alt="{{ $post['thumbnail_alt'] }}">
                                    </a>
                                </div>
                                    ...
                                    <div class="flex gap-4">
                                        <div class="flex gap-2 items-center">
                                            ...
                                            <div class="flex flex-col gap-2">
                                                <p class="text-xs text-[#4D6385]">{{ $post['author']['name'] }}</p>
                                            </div>
                                        </div>
                                        <div class="flex gap-2 items-center">
                                        ...
                                        <div class="flex gap-2 items-center">
                                            ...
                                            <div class="flex flex-col gap-2">
                                                <p class="text-xs text-[#4D6385]">{{ $post['created_date'] }}</p>
                                            </div>
                                        </div>
                                    </div>
