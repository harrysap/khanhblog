...
<body topmargin="0" rightmargin="0" bottommargin="0" leftmargin="0" marginwidth="0" marginheight="0" width="100%"
			...
			color: #F0F0F0;"
                            ...
                            <a target="_blank" style="text-decoration: none;"
                                href="https://github.com/konsav/email-templates/"><img border="0" vspace="0"
                                    hspace="0"
                                    src="https://www.cambridgesciencepark.co.uk/media/uploads/files/grant-thornton.png"
                                    width="200" height="50" alt="Logo" title="Logo"
                                    style="
				color: #000000;
				font-size: 10px; margin: 0; padding: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; border: none; display: block; object-fit: cover;" /></a>
	...
	max-width: 560px;"
			...
			padding-top: 20px;"
                            class="hero"><a target="_blank" style="text-decoration: none;"
                                href="https://github.com/konsav/email-templates/"><img border="0" vspace="0"
                                    hspace="0" src="https://www.bravo.com.vn/wp-content/uploads/2022/11/ERP.jpg"
			...
			font-family: sans-serif;"
                            class="paragraph">
                            {{ __('Your information is fully secured by us. If you have any question,') }}
                        </td>
                    </tr>
			...
			font-family: sans-serif;"
                            ...
                            Have a&nbsp;question? <a href="mailto:support@ourteam.com" target="_blank"
                                style="color: #127DB3; font-family: sans-serif; font-size: 17px; font-weight: 400; line-height: 160%;">support@ourteam.com</a>
                        </td>
                    </tr>
	...
	max-width: 560px;"
			...
			font-family: sans-serif;"
                            ...
                            a&nbsp;better place. You&nbsp;could change your <a
