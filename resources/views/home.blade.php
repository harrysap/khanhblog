    ...
    <div class="">
                    ...
                    @foreach ($featurePosts as $index => $featurePost)
                        ...
                        <div class="swiper-slide flex-shrink-0 w-full !h-auto overflow-x-hidden">
                            <div {{-- class="group w-full h-full rounded-3xl p-4 flex flex-col gap-4 justify-end cursor-default duration-300 ease-in" style="background-color: {{$featurePost['color']}}"> --}}
                                class="group w-full h-full rounded-xl p-4 flex flex-col gap-4 justify-end cursor-default duration-300 ease-in bg-white border-[0.5px] border-[#bbbbbb86]">
                                ...
                                <div class="flex justify-between gap-6 h-full">
                                            ...
                                            <div class="flex w-5 justify-center">
                                                <div class="text-lg font-light">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em"
                                                        height="1em" viewBox="0 0 1000 1000">
                                                        <path fill="currentColor"
                                    ...
                                    <div class="flex items-center flex-1 pt-10">
                                        <div class="relative group/title">
                                            <span
                                                class="relative font-medium font-manrope text-lg leading-relaxed group/title line-clamp-3">Test
                                            ...
                                            <div
                                                ...
                                                <span
                                                    ...
                                                    style="font-size: 10px">Test dài ơi là dài nè dài ơi là dài nè dài
                                                    ơi
                                                    là dài nè dài ơi là</span>
        ...
        <section
            ...
            <div x-data="{ openSections: { 1: true, 2: false, 3: false } }" class="w-full lg:w-1/4 sticky top-16 h-fit pt-16">
                ...
                <div class="mt-2">
                    ...
                    <ul x-show="openSections[1]" class="ml-4 mt-3 space-y-3 text-xs border-l border-l-[#E9E8FF] pl-4"
                        x-transition>
                        <li class="leading-slug"><span class="font-semibold mr-1">1. </span>Understanding how Links
                            and protocols work 🚀</li>
                        <li class="leading-slug"><span class="font-semibold mr-1">2. </span> HTTP, Web Browsers, and
                            Web Servers</li>
                        <li class="leading-slug"><span class="font-semibold mr-1">3. </span> Unveiling the Web Browser
                        </li>
                        <li class="leading-slug"><span class="font-semibold mr-1">4. </span>Introduction to CSS 🚀
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul x-show="openSections[2]" class="ml-4 mt-3 space-y-3 text-xs border-l border-l-[#E9E8FF] pl-4"
                        x-transition>
                        <li class="leading-slug"><span class="font-semibold mr-1">1. </span> HTML Basics</li>
                        <li class="leading-slug"><span class="font-semibold mr-1">2. </span> Semantic HTML</li>
                        <li class="leading-slug"><span class="font-semibold mr-1">3. </span> Forms and Inputs</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul x-show="openSections[3]" class="ml-4 mt-3 space-y-3 text-xs border-l border-l-[#E9E8FF] pl-4"
                        x-transition>
                        <li class="leading-slug"><span class="font-semibold mr-1">1. </span> CSS Selectors</li>
                        <li class="leading-slug"><span class="font-semibold mr-1">2. </span> Layout with Flexbox</li>
                        <li class="leading-slug"><span class="font-semibold mr-1">3. </span> Responsive Design</li>
                    </ul>
                </div>
            </div>

            <!-- Cột phải -->
            <div class="w-full lg:w-3/4 pt-6 default:pt-16 bg-bg-main z-10">
                @php
                    $posts = [
                        [
                            'category' => 'Test nè',
                                ...
                                <div class="flex flex-col justify-between flex-1 gap-4">
                                    ...
                                    <div class="relative">
                                        <span
                                            ...
                                            title="Test dài ">{{ $post['content'] }}</span>
                                    </div>
        ...
        <section>
            <div class="relative bg-white shadow-[0px_2px_5px_0px_rgba(0,0,0,0.03)] overflow-hidden">
                <div class="py-12 max-w-default w-full mx-auto px-4 sm:px-6 default:px-0 relative">
                    <div class="flex justify-between items-center">
                        <div class="flex flex-col gap-8">
                            <h3 class="font-bold text-4xl">Join to our community 🙌</h3>
                            <p class="text-lg w-9/12 leading-loose">Unlock full access to Zento and see the entire
                                library of paid-members only posts.</p>
                        </div>
                        <div class="flex flex-col items-center justify-center gap-8">
                            <p>Subscribe to our Newsletter, cancel at anytime.</p>
                            <div>
                                <button
                ...
                <svg class="absolute left-[-120px] -top-2 z-1 scale-75" width="284" height="453"
                    viewBox="0 0 284 453" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg class="absolute right-[-120px] -top-2 z-1 scale-75" width="284" height="453"
                    viewBox="0 0 284 453" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path class="text-btn-bg"
